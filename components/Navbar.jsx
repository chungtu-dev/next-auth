...
const Navbar = () => {
    ...
    return (
        <div className='p-2 m-2 rounded flex justify-between items-center shadow-xl' style={{ backgroundColor: 'rgb(139 172 225 / 49%)' }}>
            ...
            <div className='flex flex-row p-2 items-center bg-yellow-200 shadow-xl rounded-md'>
                <Image className='rounded-full m-2' src={session?.user?.image ? session?.user?.image : "https://cdn.pixabay.com/photo/2014/03/24/17/06/bird-295026_1280.png"} width={60} height={60} alt="user img" />
